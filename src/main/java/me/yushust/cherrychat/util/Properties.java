...
public class Properties {
    ...
    private static Object getPropertyManager() throws Exception {
        Class<?> minecraftServer = Class.forName("net.minecraft.server." + ChatPlugin.getServerVersion() + ".MinecraftServer");
        Class<?> dedicatedServer = Class.forName("net.minecraft.server." + ChatPlugin.getServerVersion() + ".DedicatedServer");
